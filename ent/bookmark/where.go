...
func StatusIDGT(v uint64) predicate.Bookmark {
	return predicate.Bookmark(sql.FieldGT(FieldStatusID, v))
}

// StatusIDGTE applies the GTE predicate on the "status_id" field.
func StatusIDGTE(v uint64) predicate.Bookmark {
	return predicate.Bookmark(sql.FieldGTE(FieldStatusID, v))
}

// StatusIDLT applies the LT predicate on the "status_id" field.
func StatusIDLT(v uint64) predicate.Bookmark {
	return predicate.Bookmark(sql.FieldLT(FieldStatusID, v))
}

// StatusIDLTE applies the LTE predicate on the "status_id" field.
func StatusIDLTE(v uint64) predicate.Bookmark {
	return predicate.Bookmark(sql.FieldLTE(FieldStatusID, v))
}
...
func ProfileIDGT(v uint64) predicate.Bookmark {
	return predicate.Bookmark(sql.FieldGT(FieldProfileID, v))
}

// ProfileIDGTE applies the GTE predicate on the "profile_id" field.
func ProfileIDGTE(v uint64) predicate.Bookmark {
	return predicate.Bookmark(sql.FieldGTE(FieldProfileID, v))
}

// ProfileIDLT applies the LT predicate on the "profile_id" field.
func ProfileIDLT(v uint64) predicate.Bookmark {
	return predicate.Bookmark(sql.FieldLT(FieldProfileID, v))
}

// ProfileIDLTE applies the LTE predicate on the "profile_id" field.
func ProfileIDLTE(v uint64) predicate.Bookmark {
	return predicate.Bookmark(sql.FieldLTE(FieldProfileID, v))
}
