...
func (_c *CollectionCreate) SetProfileID(v uint64) *CollectionCreate {
	_c.mutation.SetProfileID(v)
	return _c
}

// SetNillableProfileID sets the "profile_id" field if the given value is not nil.
func (_c *CollectionCreate) SetNillableProfileID(v *uint64) *CollectionCreate {
	if v != nil {
		_c.SetProfileID(*v)
	}
	return _c
...
func (_c *CollectionCreate) SetNillableTitle(v *string) *CollectionCreate {
	if v != nil {
		_c.SetTitle(*v)
	}
	return _c
...
func (_c *CollectionCreate) SetIsNsfw(v bool) *CollectionCreate {
	_c.mutation.SetIsNsfw(v)
	return _c
}

// SetNillableIsNsfw sets the "is_nsfw" field if the given value is not nil.
func (_c *CollectionCreate) SetNillableIsNsfw(v *bool) *CollectionCreate {
	if v != nil {
		_c.SetIsNsfw(*v)
	}
	return _c
...
func (_c *CollectionCreate) SetVisibility(v string) *CollectionCreate {
	_c.mutation.SetVisibility(v)
	return _c
}

// SetNillableVisibility sets the "visibility" field if the given value is not nil.
func (_c *CollectionCreate) SetNillableVisibility(v *string) *CollectionCreate {
	if v != nil {
		_c.SetVisibility(*v)
	}
	return _c
...
func (_c *CollectionCreate) SetPublishedAt(v time.Time) *CollectionCreate {
	_c.mutation.SetPublishedAt(v)
	return _c
}

// SetNillablePublishedAt sets the "published_at" field if the given value is not nil.
func (_c *CollectionCreate) SetNillablePublishedAt(v *time.Time) *CollectionCreate {
	if v != nil {
		_c.SetPublishedAt(*v)
	}
	return _c
...
func (_c *CollectionCreate) SetID(v uint64) *CollectionCreate {
	_c.mutation.SetID(v)
	return _c
}
...
func (_c *CollectionCreate) check() error {
	if _, ok := _c.mutation.IsNsfw(); !ok {
		return &ValidationError{Name: "is_nsfw", err: errors.New(`ent: missing required field "Collection.is_nsfw"`)}
	}
	if _, ok := _c.mutation.Visibility(); !ok {
...
func (_c *CollectionCreate) createSpec() (*Collection, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(collection.Table, sqlgraph.NewFieldSpec(collection.FieldID, field.TypeUint64))
	)
