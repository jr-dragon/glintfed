...
func (_q *CollectionQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *CollectionQuery) FirstIDX(ctx context.Context) uint64 {
...
func (_q *CollectionQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *CollectionQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (_q *CollectionQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (_q *CollectionQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(collection.FieldProfileID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.Collection.Query().
//		Select(collection.FieldProfileID).
//		Scan(ctx, &v)
...
func (_q *CollectionQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(collection.Table, collection.Columns, sqlgraph.NewFieldSpec(collection.FieldID, field.TypeUint64))
	_spec.From = _q.sql
