...
func (_q *ContactQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *ContactQuery) FirstIDX(ctx context.Context) uint64 {
...
func (_q *ContactQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *ContactQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (_q *ContactQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (_q *ContactQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
