...
func (_q *ConversationQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *ConversationQuery) FirstIDX(ctx context.Context) uint64 {
...
func (_q *ConversationQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *ConversationQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (_q *ConversationQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (_q *ConversationQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(conversation.FieldToID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
func (_q *ConversationQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(conversation.Table, conversation.Columns, sqlgraph.NewFieldSpec(conversation.FieldID, field.TypeUint64))
	_spec.From = _q.sql
