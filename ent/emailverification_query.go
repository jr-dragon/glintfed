...
func (_q *EmailVerificationQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *EmailVerificationQuery) FirstIDX(ctx context.Context) uint64 {
...
func (_q *EmailVerificationQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *EmailVerificationQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (_q *EmailVerificationQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (_q *EmailVerificationQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(emailverification.FieldUserID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.EmailVerification.Query().
//		Select(emailverification.FieldUserID).
//		Scan(ctx, &v)
...
func (_q *EmailVerificationQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(emailverification.Table, emailverification.Columns, sqlgraph.NewFieldSpec(emailverification.FieldID, field.TypeUint64))
	_spec.From = _q.sql
