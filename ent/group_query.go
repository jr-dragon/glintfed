...
func (_q *GroupQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *GroupQuery) FirstIDX(ctx context.Context) uint64 {
...
func (_q *GroupQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *GroupQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (_q *GroupQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (_q *GroupQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *GroupQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(group.Table, group.Columns, sqlgraph.NewFieldSpec(group.FieldID, field.TypeUint64))
	_spec.From = _q.sql
