...
const (
	// Label holds the string label denoting the groupinteraction type in the database.
	Label = "group_interaction"
	...
	// Table holds the table name of the groupinteraction in the database.
	Table = "group_interactions"
)

// Columns holds all SQL columns for groupinteraction fields.
var Columns = []string{
	FieldID,
	FieldGroupID,
	FieldProfileID,
...
// OrderOption defines the ordering options for the GroupInteraction queries.
