...
func (_q *LikeQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *LikeQuery) FirstIDX(ctx context.Context) uint64 {
...
func (_q *LikeQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *LikeQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (_q *LikeQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (_q *LikeQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *LikeQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(like.Table, like.Columns, sqlgraph.NewFieldSpec(like.FieldID, field.TypeUint64))
	_spec.From = _q.sql
