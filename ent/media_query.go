...
func (_q *MediaQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *MediaQuery) FirstIDX(ctx context.Context) uint64 {
...
func (_q *MediaQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *MediaQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (_q *MediaQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (_q *MediaQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *MediaQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(media.Table, media.Columns, sqlgraph.NewFieldSpec(media.FieldID, field.TypeUint64))
	_spec.From = _q.sql
