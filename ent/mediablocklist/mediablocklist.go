...
const (
	// Label holds the string label denoting the mediablocklist type in the database.
	Label = "media_blocklist"
	...
	// Table holds the table name of the mediablocklist in the database.
	Table = "media_blocklists"
)

// Columns holds all SQL columns for mediablocklist fields.
var Columns = []string{
	FieldID,
	FieldSha256,
	FieldSha512,
...
// OrderOption defines the ordering options for the MediaBlocklist queries.
