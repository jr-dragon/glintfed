...
func (_q *NotificationQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *NotificationQuery) FirstIDX(ctx context.Context) uint64 {
...
func (_q *NotificationQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *NotificationQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (_q *NotificationQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (_q *NotificationQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(notification.FieldProfileID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.Notification.Query().
//		Select(notification.FieldProfileID).
//		Scan(ctx, &v)
...
func (_q *NotificationQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(notification.Table, notification.Columns, sqlgraph.NewFieldSpec(notification.FieldID, field.TypeUint64))
	_spec.From = _q.sql
