...
const (
	// Label holds the string label denoting the oauthpkce type in the database.
	Label = "oauth_pkce"
	...
	// Table holds the table name of the oauthpkce in the database.
	Table = "oauth_pkce"
)

// Columns holds all SQL columns for oauthpkce fields.
var Columns = []string{
	FieldID,
	FieldRequestID,
	FieldClientID,
...
// OrderOption defines the ordering options for the OauthPkce queries.
