...
func (_q *OauthRefreshTokenQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *OauthRefreshTokenQuery) FirstIDX(ctx context.Context) string {
...
func (_q *OauthRefreshTokenQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *OauthRefreshTokenQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *OauthRefreshTokenQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *OauthRefreshTokenQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
