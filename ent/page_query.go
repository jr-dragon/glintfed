...
func (_q *PageQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *PageQuery) FirstIDX(ctx context.Context) uint64 {
...
func (_q *PageQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *PageQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (_q *PageQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (_q *PageQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *PageQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(page.Table, page.Columns, sqlgraph.NewFieldSpec(page.FieldID, field.TypeUint64))
	_spec.From = _q.sql
