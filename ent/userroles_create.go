...
func (_c *UserRolesCreate) SetProfileID(v uint64) *UserRolesCreate {
	_c.mutation.SetProfileID(v)
	return _c
}

// SetNillableProfileID sets the "profile_id" field if the given value is not nil.
func (_c *UserRolesCreate) SetNillableProfileID(v *uint64) *UserRolesCreate {
	if v != nil {
		_c.SetProfileID(*v)
	}
	return _c
...
func (_c *UserRolesCreate) SetUserID(v uint64) *UserRolesCreate {
	_c.mutation.SetUserID(v)
	return _c
}

// SetRoles sets the "roles" field.
func (_c *UserRolesCreate) SetRoles(v []string) *UserRolesCreate {
	_c.mutation.SetRoles(v)
	return _c
}

// SetMeta sets the "meta" field.
func (_c *UserRolesCreate) SetMeta(v map[string]interface{}) *UserRolesCreate {
...
func (_c *UserRolesCreate) SetID(v uint64) *UserRolesCreate {
	_c.mutation.SetID(v)
	return _c
}
...
func (_c *UserRolesCreate) check() error {
	...
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent: missing required field "UserRoles.created_at"`)}
	}
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`ent: missing required field "UserRoles.updated_at"`)}
	}
	return nil
}
...
func (_c *UserRolesCreate) createSpec() (*UserRoles, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(userroles.Table, sqlgraph.NewFieldSpec(userroles.FieldID, field.TypeUint64))
	)
